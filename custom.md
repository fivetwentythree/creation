...
I did this small change to test lazygit
...
2. **Save** that value to a temporary variable (if you need to return the _current_ state before incrementing).
3. **Update** the state (increment `self.counter`) for the _next_ call.
